...
class ContactPage(BasePage):
    ...
    PASSENGER_FIRST_NAME_FIELD = '[placeholder="שם פרטי"]'
    PASSENGER_LAST_NAME_FIELD = '[placeholder="שם משפחה"]'
    PASSENGER_BIRTHDAY_DATE = '[placeholder="dd/mm/yyyy"]'
    PASSENGER_DROPDOWN = ".subject-wrapper >.dropdown-subject"
    PASSENGER_DROPDOWN_SELECT_MALE_GENDER = ".options-container.withoutPassport.show > .option:nth-child(1)"
    NO_BAGGAGE_ADDED_OUTBOUND = ".baggages-wrapper .baggage-segment:nth-child(1) .baggage-upgrade-row:nth-child(3) .baggage-item:nth-child(1) .radio-input"
    NO_BAGGAGE_ADDED_INBOUND = ".baggages-wrapper .baggage-segment:nth-child(2) .baggage-upgrade-row:nth-child(3) .baggage-item:nth-child(1) .radio-input"
    ONE_BAGGAGE_ADDED_OUTBOUND = ".baggages-wrapper .baggage-segment:nth-child(1) .baggage-upgrade-row:nth-child(3) .baggage-item:nth-child(2) .radio-input"
    ONE_BAGGAGE_ADDED_INBOUND = ".baggages-wrapper .baggage-segment:nth-child(2) .baggage-upgrade-row:nth-child(3) .baggage-item:nth-child(2) .radio-input"
    ...
    def fill_passenger_info(self, passenger_first_name, passenger_last_name, birthday_date):
        ...
        gender_dropdown = self._page.locator(self.PASSENGER_DROPDOWN)
        ...
        male_option = self._page.locator(self.PASSENGER_DROPDOWN_SELECT_MALE_GENDER)
    ...
    def continue_to_next_page_with_recovery(self, contact_first_name, contact_last_name, passenger_first_name,
        ...
        if scroll_y_after < scroll_y_before - 100 and url_before == url_after:
            ...
            self._page.locator(self.PASSENGER_DROPDOWN).wait_for(state="visible", timeout=30000)
