...
class AncillariesPage(BasePage):
    ...
    PREMIUM_FLEX_SERVICE_PACKAGE_CHOOSE_BTN = "app-service-card:nth-child(1) .card-header-container .radio-circle"
    CANCELLATION_PROTECTION = "app-service-card:nth-child(2) .head"
    CANCELLATION_PROTECTION_BTN = "app-service-card:nth-child(2) .card-header-container .radio-circle"
    BAGGAGE_PROTECTION = "app-service-card:nth-child(3) .head"
    BAGGAGE_PROTECTION_BTN = "app-service-card:nth-child(3) .card-header-container .radio-circle"
