...
class TestFlightBooking(BaseTest):
    ...
    def test_home_to_step3_contact_page(self, page):
        ...
        self.contact_page = ContactPage(new_tab)
        self.contact_page.wait_for_contact_page_to_load()
        self.contact_page.fill_contact_info(contact_first_name, contact_last_name, email, confirmation_email, phone_number)
        self.contact_page.fill_passenger_info(passenger_first, passenger_last, birthday_date)
        self.contact_page.add_outbound_baggage()
        self.contact_page.add_inbound_baggage()
        self.contact_page.continue_to_next_page_with_recovery(contact_first_name, contact_last_name, passenger_first, passenger_last, email, confirmation_email, phone_number, birthday_date)